      ...
      <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
        <div class="rounded overflow-hidden shadow-lg">
          ...
          <div class="px-6 py-4">
            ...
            <p class="text-gray-700 text-base">
              Range of exercises to effectively train your Chests, Biceps,
              Triceps, Shoulders and Back.
            </p>
            <div className="py-2">
              <a href="/app/workout" className="text-blue-700 text-base">
                Start Workout
              </a>
            </div>
          </div>
        ...
        <div class="rounded overflow-hidden shadow-lg">
          ...
          <div class="px-6 py-4">
            ...
            <p class="text-gray-700 text-base">
              Range of exercises to effectively train your Legs and Gluteus
              Maximus.
            </p>
            <div className="py-2">
              <a href="/app/workout" className="text-blue-700 text-base">
        ...
        <div class="rounded overflow-hidden shadow-lg">
          ...
          <div class="px-6 py-4">
            ...
            <p class="text-gray-700 text-base">
              Workouts that involve short periods of intense exercise alternated
